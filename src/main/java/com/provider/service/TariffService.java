 ...
 */
public abstract class TariffService extends AbstractService {
    protected TariffService() throws DBException {}
     ...
     */
    public abstract @NotNull List<Service> findAllServices(@NotNull String locale) throws DBException;
     ...
     * @throws DBException if {@link com.provider.dao.ServiceDao} throws DBException
     */
    public abstract boolean insertService(@NotNull Service service) throws DBException, ValidationException;
     ...
     */
    public abstract @NotNull List<TariffDto> findTariffsPage(long offset,
                                             int limit,
     ...
     */
    public abstract @NotNull Optional<Tariff> findTariffById(int tariffId) throws DBException;
     ...
     */
    public abstract @NotNull Optional<TariffDto> findTariffFullInfoById(int tariffId, @NotNull String locale)
            throws DBException;
     ...
     * @throws DBException if {@link com.provider.dao.TariffDao} throws DBException
     */
    public abstract int countAllTariffs() throws DBException;
     ...
     * @throws DBException if {@link com.provider.dao.TariffDao} throws DBException
     */
    public abstract int countActiveTariffs() throws DBException;
     ...
     */
    public abstract boolean insertTariff(@NotNull Tariff tariff, @NotNull TariffDuration tariffDuration,
     ...
     */
    public abstract @NotNull Map<Service, Integer> findAllServicesTariffsCount(@NotNull String locale, boolean activeOnly)
            throws DBException;
     ...
     */
    public abstract boolean updateTariff(@NotNull Tariff tariff) throws DBException, ValidationException;
     ...
     * @throws java.util.NoSuchElementException if tariff does not exist
     */
    public abstract boolean upsertTariffTranslation(@NotNull Tariff tariff, @NotNull String locale)
     ...
     */
    public abstract void writeTariffPdf(@NotNull TariffDto tariffDto, @NotNull OutputStream os);
}
