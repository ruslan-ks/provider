...
DROP TABLE IF EXISTS possible_user_statuses CASCADE;
CREATE TABLE possible_user_statuses(
    id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    name TEXT UNIQUE NOT NULL
);
...
DROP TABLE IF EXISTS user_status_flow CASCADE;
CREATE TABLE user_status_flow(
    from_status_id INT NOT NULL,
    to_status_id INT NOT NULL,
    CONSTRAINT unique_flow UNIQUE(from_status_id, to_status_id),
    FOREIGN KEY(from_status_id) REFERENCES possible_user_statuses(id)
        ON DELETE CASCADE,
    FOREIGN KEY(to_status_id) REFERENCES possible_user_statuses(id)
        ON DELETE CASCADE
);
...
CREATE TABLE user_statuses(
    ...
    FOREIGN KEY(user_id) REFERENCES users(id)
        ON DELETE CASCADE,
    FOREIGN KEY(status_id) REFERENCES possible_user_statuses(id)
);
...
INSERT INTO possible_user_statuses(name)
VALUES
    ('active'),
    ('suspended');
